...
{
		printf("%s (Dump Power module information)\n", argv0);
		printf("%s -on (Set PMBus switch On)\n", argv0);
		printf("%s -off (Set PMBus switch Off)\n", argv0);
    //printf("****************************************************************\n");		
    //printf("** Lanner Electronics Inc.  2018-08-16\n");
    //printf("** PMBUS utility  Ver, 1.2 for NCB-5220\n");
    //printf("****************************************************************\n");	
 }
//===========================================
//MAIN
...
//     	help();
    printf("****************************************************************\n");		
    printf("** Lanner Electronics Inc.  2018-09-10\n");
    printf("** PMBUS utility  Ver, 1.3 for NCB-5220\n");
    printf("****************************************************************\n");	
		if ( argc > 2) {
                help(argv[0]);
                return -1;
		...
		GpioBaseInit();
#endif   
//+v1.2 add pmbus switch on/off function for test
	if (argc==2){ 
		if ( !strcmp(argv[1], "-on")) {
			printf("Set PMbus switch On\n");
			SetGpioLvlSel(GPP_K11_Offset, 0x00);
		}
		else if ( !strcmp(argv[1], "-off")) {
			printf("Set PMbus switch Off\n");
...
//-v1.2 		GpioBaseInit();
//-v1.2 #endif
//-V1.3		SetGpioLvlSel(GPP_K11_Offset, 0x00);
//-----------		  
		read_byte(0xB0,0x00);
	 	  if (smb_err!=0x00){
...
//-V1.3		SetGpioLvlSel(GPP_K11_Offset, 0x01);
} //argc==1
